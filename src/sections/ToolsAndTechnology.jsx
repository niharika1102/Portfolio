...
//           <div key={index} className="relative group flex justify-center items-center rounded-full bg-transparent border border-green-500 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 mx-auto">
...
const ToolsAndTechnologies = () => {
  return (
    <section className="py-12 px-4 md:px-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {tools.map((tool, index) => (
          <div key={index} className="relative group flex justify-center items-center rounded-full bg-transparent border border-green-500 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 mx-auto p-2">
